    ...
    <main className="min-h-screen bg-[#F8FAFC] text-slate-900 flex flex-col font-sans">
      ...
      <header className="w-full bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          >
            <div className="relative w-9 h-9 flex items-center justify-center rounded-xl bg-gradient-to-br from-white to-slate-50 p-1 border border-slate-200 shadow-xs group-hover:border-[#ff5e00]/40 transition-colors">
              <Image
                src="/logo.png"
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-all"
          >
      ...
      {/* Main Content Area */}
      <div className="grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="bg-white rounded-3xl border border-slate-200 shadow-md p-6 sm:p-10 lg:p-12 space-y-8">
          
          {/* Header Title */}
          <div className="border-b border-slate-200 pb-8">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#ff5e00]/10 border border-[#ff5e00]/20 text-[#ff5e00] text-xs font-semibold mb-4">
              <ShieldCheck className="w-3.5 h-3.5" />
              <span>DATA PROTECTION</span>
            </div>
            <h1 className="font-changa text-3xl sm:text-5xl font-extrabold uppercase tracking-tight text-slate-950">
