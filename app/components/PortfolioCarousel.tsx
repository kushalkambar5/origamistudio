    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="font-changa text-3xl sm:text-5xl md:text-6xl font-extrabold uppercase tracking-tight text-white leading-none mb-4">
            Curious What Else We’ve Created?
          </h2>

          {/* Subtitle */}
          <p className="text-slate-300 text-sm sm:text-base font-light max-w-2xl mx-auto leading-relaxed mb-6">
          ...
          <div className="flex justify-center">
            <a
              href="#get-in-touch"
              className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white hover:bg-slate-100 text-slate-950 font-semibold text-sm transition-all duration-300 shadow-lg hover:scale-105 active:scale-95 group"
            >
        ...
        <div className="relative my-12 py-8">
              ...
              return (
                <div
                  ...
                  className={`snap-center shrink-0 w-64 sm:w-72 md:w-80 cursor-pointer rounded-3xl overflow-hidden border transition-all duration-500 group ${
                    isActive
                      ? "border-[#FC6100] shadow-[0_0_40px_rgba(252,97,0,0.4)] z-30"
                      : "border-white/10 hover:border-white/30 opacity-80 hover:opacity-100 z-10"
                  } bg-[#0F1420]`}
                >
                  {/* Image Frame */}
                  <div className="relative h-80 sm:h-96 w-full overflow-hidden bg-slate-900">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0F1420] via-black/20 to-transparent" />

                    {/* Step Badge */}
                    <div className="absolute top-4 left-4 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-[#FC6100]/40 text-[#FC6100] font-changa text-xs font-bold">
                      {item.stepNumber}
                    </div>
                  ...
                  <div className="p-5 text-center bg-[#0F1420]">
                    <span className="font-changa text-base font-bold text-[#FC6100] block mb-1">
                      {item.stepNumber}
                    </span>
                    <h3 className="font-changa text-lg font-bold text-white uppercase tracking-tight">
                      {item.title}
                    </h3>
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              ...
              className="p-3 rounded-full bg-white/5 border border-white/10 text-white hover:bg-[#FC6100] hover:border-[#FC6100] transition-colors shadow-md"
            >
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
          <div className="relative w-full max-w-3xl bg-[#0F1420] border border-[#FC6100]/50 rounded-3xl overflow-hidden shadow-2xl max-h-[90vh] overflow-y-auto">
            <button
              onClick={() => setSelectedItem(null)}
              className="absolute top-4 right-4 z-20 p-2 rounded-full bg-black/60 text-white hover:bg-[#FC6100] transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="relative h-64 sm:h-80 w-full">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0F1420] via-black/40 to-transparent" />
              <div className="absolute bottom-6 left-6 right-6">
                <span className="px-3 py-1 rounded-full bg-[#FC6100] text-white text-xs font-mono font-bold uppercase">
                  {selectedItem.stepNumber} • {selectedItem.category}
                </span>
                <h3 className="font-changa text-2xl sm:text-4xl font-extrabold text-white mt-2">
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mb-6 p-4 rounded-2xl bg-black/50 border border-slate-800 flex items-center justify-between">
              ...
              <div className="mb-8">
                <h4 className="font-changa text-lg font-bold text-white uppercase mb-3 flex items-center gap-2">
